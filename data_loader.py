...
'''
def imagenet_data_loader(args, is_micro_batch):
    traindir = os.path.join(args.data_dir, 'train')
    valdir = os.path.join(args.data_dir, 'val')
    train_batch_size = args.micro_batch_size if is_micro_batch else args.mini_batch_size
...
'''
def cifar10_dataset_loader(args, is_micro_batch):
